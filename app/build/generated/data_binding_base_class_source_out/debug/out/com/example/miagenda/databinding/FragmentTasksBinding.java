...
public final class FragmentTasksBinding implements ViewBinding {
  ...
  private FragmentTasksBinding(@NonNull RelativeLayout rootView,
      @NonNull FloatingActionButton fabAgregarEvento, @NonNull TextView tvTaskName,
  ...
  public static FragmentTasksBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTasksBinding((RelativeLayout) rootView, fabAgregarEvento, tvTaskName,
          tvTaskNameLabel, tvTimeRemaining, tvTimeRemainingLabel);
    }
